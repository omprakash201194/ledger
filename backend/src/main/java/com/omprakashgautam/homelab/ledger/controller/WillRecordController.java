...
public class WillRecordController {
    ...
    @GetMapping
    public ResponseEntity<WillRecordResponse> get(@AuthenticationPrincipal UserDetailsImpl principal) {
    ...
    @PutMapping
    public ResponseEntity<WillRecordResponse> upsert(@RequestBody WillRecordRequest request,
